...
public class FilterFactory {
    ...
    public static Filter create(String className) {
        ...
        try {
            ...
            log.error("Filter class {} not found in package {}.", className, packagePath);
            return null;
        } catch (NoSuchMethodException | InstantiationException | IllegalAccessException | InvocationTargetException ex) {
            log.error("Filter class {} in package {} can not be instantiated.", className, packagePath);
            return null;
        }
    }
